...
const (
	...
	NeedRecoveryObservationMissing     NeedCode = "primary_recovery_observation_missing"
	NeedRecoveryObservationInvalid     NeedCode = "primary_recovery_observation_invalid"
	NeedRecoveryFactsInvalid           NeedCode = "primary_recovery_facts_invalid"
	NeedRecoveryBindingContradictory   NeedCode = "primary_recovery_binding_contradictory"
	NeedRecoveryWorkspaceInvalid       NeedCode = "primary_recovery_workspace_invalid"
	NeedRecoveryResourceContradictory  NeedCode = "primary_recovery_resource_contradictory"
	NeedRecoveryDuplicatePrimary       NeedCode = "primary_recovery_duplicate_primary"
	NeedRecoveryOrphanResource         NeedCode = "primary_recovery_orphan_resource"
	NeedRecoveryCandidateContradictory NeedCode = "primary_recovery_candidate_contradictory"
	NeedRecoveryAuthorityContradictory NeedCode = "primary_recovery_authority_contradictory"
	NeedRecoveryBudgetBlocked          NeedCode = "primary_recovery_budget_blocked"
	NeedRecoveryHelperAmbiguous        NeedCode = "primary_recovery_helper_ambiguous"
	NeedRecoveryFailureRequiresHuman   NeedCode = "primary_recovery_failure_requires_human"
	NeedRecoveryPromptAmbiguous        NeedCode = "primary_recovery_prompt_ambiguous"
	NeedRecoveryTerminationUnproven    NeedCode = "primary_recovery_termination_unproven"
	NeedRecoverySecondFailure          NeedCode = "primary_recovery_second_failure"
	NeedRecoveryReplacementExhausted   NeedCode = "primary_recovery_replacement_exhausted"
	NeedRecoveryLeaseAmbiguous         NeedCode = "primary_recovery_lease_ambiguous"
	NeedRecoveryVisibilityInvalid      NeedCode = "primary_recovery_visibility_invalid"
	NeedRecoveryEnforcementUnavailable NeedCode = "primary_recovery_enforcement_unavailable"
)
