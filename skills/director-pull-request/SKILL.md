...
5. Never merge unless the Task explicitly authorizes it and every configured gate remains valid.
6. Close the Beads Task only after integration and cleanup are verified.
